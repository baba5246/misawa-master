...
#define ACCESS_KEY_ID          @"AKIAJIYHWTHQNLERUSVQ"
#define SECRET_KEY             @"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"

// Constants for the Bucket and Object name.
#define PICTURE_BUCKET         @"photoes"
#define PICTURE_NAME           @"misawa"
